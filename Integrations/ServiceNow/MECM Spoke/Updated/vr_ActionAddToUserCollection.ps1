...
# Add Log Header
  SNCLog-DebugInfo "------------------------------------------------------------------------------"
  SNCLog-DebugInfo "  MECM Toolkit - Integrations - MECM Spoke - Add to User Collection"
  SNCLog-DebugInfo "------------------------------------------------------------------------------"
  ...
  SNCLog-DebugInfo "    Purpose:    Add a user to the specified collection within MECM."
