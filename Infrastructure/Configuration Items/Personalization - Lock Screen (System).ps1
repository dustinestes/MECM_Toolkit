...
#   Description: Prevents users from changing the lock screen background.
#   Options:
#     State: Not Configured (null), Enabled (1), Disabled (0)
#   URL: https://gpsearch.azurewebsites.net:/Default.aspx?PolicyID=7402
#   ADMX: ControlPanelDisplay.admx
# HKLM:\SOFTWARE\Policies\Microsoft\Windows\Personalization
...
#Region Input
  ...
  # MECM Settings
    $Name_ConfigurationItem = "CI - Personalization - Lock Screen (System)"
  ...
  # File & Directory
    $File_01 = @{
      "Path" = "$($env:vr_Directory_Cache)\Backgrounds\Background.png"
    }
