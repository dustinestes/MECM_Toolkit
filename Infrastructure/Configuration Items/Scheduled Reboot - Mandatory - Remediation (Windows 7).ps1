...
#Region Input
    ...
    # Reboot Settings
        $Settings_CalculatedRebootTime_UTC = [int64]$(Get-Date ((Get-Date -Date "$(Get-Date -Format yyyy)-$(Get-Date -Format MM)-01T01:30:00").ToUniversalTime()) -Uformat %s)
...
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Triggers>
    <CalendarTrigger>
      <StartBoundary>2024-08-01T00:00:00</StartBoundary>
