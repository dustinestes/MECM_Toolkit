...
param (
    [string]$Source,                  # '%vr_Cache_SupportCenter01%\*'
    [string]$Destination              # '%vr_Directory_Tools%\Support Center'
)
...
#Region Header
    ...
    Write-Host "------------------------------------------------------------------------------"
    Write-Host "  Task Sequence Toolkit - Support Center - Cache Files"
    Write-Host "------------------------------------------------------------------------------"
    Write-Host "    Author:     Dustin Estes"
    Write-Host "    Company:    VividRock"
    Write-Host "    Date:       December 23, 2019"
    Write-Host "    Copyright:  VividRock LLC - All Rights Reserved"
    Write-Host "    Purpose:    This script will copy the Support Center content from the"
    Write-Host "                Source location to the Destination location."
